    ...
    return (
        <div className="min-h-screen bg-white text-gray-800">
            ...
            <section className="bg-gradient-to-r from-indigo-500 to-purple-600 text-white py-24 px-6 text-center">
                ...
                <RotatingText
                    texts={["Earn NFTs", "Get Rewards", "Trade Collectibles", "Own the Experience"]}
                    mainClassName="my-6 px-4 py-2 bg-white text-indigo-600 font-bold text-lg md:text-2xl rounded-lg inline-flex justify-center"
                    staggerFrom="last"
            ...
            <section className="bg-white py-16 px-6 md:px-20">
                <div className="max-w-7xl mx-auto text-center">
                    ...
                    <p className="text-gray-600 text-lg md:text-xl mb-12">
                        Partner with us to offer NFT loyalty rewards and grow customer
                        retention.
                    </p>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-left">
                        ...
                        <div className="bg-indigo-50 p-6 rounded-2xl shadow hover:shadow-lg transition">
                            ...
                            <p className="mt-2 text-gray-600 mb-4">
                                Ready to reward your customers with NFTs? Start your journey
                                today.
                            </p>
                            <a
                                href="/partner"
                        ...
                        <div className="bg-white border p-6 rounded-2xl shadow hover:shadow-lg transition">
                            ...
                            <p className="mt-2 text-gray-600 mb-4">
                                Curious about how it works? Request a free walkthrough tailored
                                to your brand.
                            </p>
                            <a
                                href="/partner#demo"
